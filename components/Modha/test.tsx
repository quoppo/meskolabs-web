    ...
    <div>
      ...
      <div>
        <div className="snap-y snap-mandatory h-screen w-screen mx:auto overflow-x-hidden">
          {/*  */}
          <div
  className="snap-start grid w-screen h-screen place-items-center text-4xl md:text-6xl lg:text-8xl"
  style={{
...
>
  ...
  >
    <div className="flex flex-col md:flex-row items-start h-full px-5 md:px-20 lg:px-40">
      <div className="pt-40 md:pt-60 lg:pt-80">
        <h3
        ...
        <div className="mt-5 md:mt-8">
          <button className="bg-black text-white px-6 py-3 md:px-8 md:py-4 text-sm md:text-base lg:text-lg rounded-full hover:bg-white hover:text-black border-2 border-black font-inter font-medium">
            Know More
          </button>
        </div>
      </div>
