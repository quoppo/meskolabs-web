...
const ProjectCard: React.FC<ProjectCardProps> = ({ imgPath, title, description, buttonNavigation }) => {
  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      ...
      <div>
        <button className="bg-black text-white p-2 px-5 text-xs rounded-lg hover:bg-white hover:text-black border-2 border-black mt-1 font-inter" onClick={navigateToPage}>
          Read More
        </button>
      </div>
    </div>
